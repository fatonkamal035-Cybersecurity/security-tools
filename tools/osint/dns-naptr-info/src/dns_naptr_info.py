"""Read-only DNS NAPTR record lookup."""
...
def resolve_naptr_records(
    hostname: str,
) -> list[dict[str, object]]:
    """Resolve NAPTR records for one explicitly provided hostname."""
    ...
    records = {
        (
            ...
            str(answer.service),
            str(answer.regexp),
            str(answer.replacement).rstrip(".").lower(),
        )
