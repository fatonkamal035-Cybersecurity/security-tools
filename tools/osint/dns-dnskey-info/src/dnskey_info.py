"""Read-only DNS DNSKEY record lookup."""
...
def resolve_dnskey_records(
    hostname: str,
) -> list[dict[str, object]]:
    """Resolve DNSKEY records for one explicitly provided hostname."""
    ...
    return [
        ...
        for flags, protocol, algorithm, key in sorted(records)
    ]
