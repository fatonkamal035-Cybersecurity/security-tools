"""Read-only DNS MX record lookup."""
...
def resolve_mx_records(
    ...
    """Resolve MX records for one explicitly provided hostname."""
    ...
    records = {
        (
            ...
            (
                ...
                else str(answer.exchange).rstrip(".").lower()
            ),
        )
    ...
    return [
        ...
        for priority, exchange in sorted(records)
    ]
