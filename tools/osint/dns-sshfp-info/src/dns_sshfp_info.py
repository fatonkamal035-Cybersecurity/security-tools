"""Read-only DNS SSHFP record lookup."""
...
def resolve_sshfp_records(
    hostname: str,
) -> list[dict[str, object]]:
    """Resolve SSHFP records for one explicitly provided hostname."""
    ...
    return [
        ...
        for algorithm, fingerprint_type, fingerprint in sorted(records)
    ]
