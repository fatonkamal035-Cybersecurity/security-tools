"""Read-only DNS HINFO record lookup."""
...
def resolve_hinfo_records(
    hostname: str,
) -> list[dict[str, str]]:
    """Resolve HINFO records for one explicitly provided hostname."""
    ...
    return [
        ...
        for cpu, operating_system in sorted(records)
    ]
